    ...
    for idx2 = 1:numel(numHiddenUnits)
        for idx3 = 1:numel(numFilters)
            for idx4 = 1:numel(mBatch)
                ...
                lgraph = addLayers(lgraph, convolution1dLayer(filterSize, numFilters(idx3), 'WeightLearnRateFactor', 0, 'BiasLearnRateFactor', 0, 'Name', 'conv_1'));
...
idx11 = [1 4 7 10 13 16 19 22 25 28];  % Depend on 'nRuns'; (i.e. if nRuns=3 -> idx11=[1 4 7]) -> TO BE SET!!!
idx22 = idx11 + 1;
idx33 = idx22 + 1;
